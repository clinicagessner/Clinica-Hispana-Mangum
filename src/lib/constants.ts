...
${AREAS_EN}`,
  },
  {
    ...
    metaTitle: "Examen Físico Escolar y Deportivo en Houston · Sin Cita, en Español",
...
${AREAS_EN}`,
  },
  {
    ...
    shortDescription: "Exámenes de salud del hombre: antígeno prostático (PSA), testosterona y chequeo general, en español.",
    shortDescriptionEn: "Men's health exams: prostate antigen (PSA), testosterone and general checkup, in Spanish.",
...
${AREAS_EN}`,
  },
  {
    ...
    metaTitle: "Examen Médico de Inmigración I-693 en Houston · Médico Autorizado por USCIS",
    metaTitleEn: "I-693 Immigration Medical Exam in Houston · USCIS Civil Surgeon",
