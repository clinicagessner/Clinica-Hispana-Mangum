      ...
      <section className="relative isolate overflow-hidden bg-gradient-to-br from-green-deep via-green-dark to-green-deep py-16 text-mint-bg lg:py-20">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 flex flex-col gap-5 lg:flex-row lg:items-start lg:gap-6">
            <span className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-white/10 text-gold-accent-light">
              <ServiceIcon name={l.icon} className="h-8 w-8" />
            </span>
            <div>
              <span className="text-xs font-semibold uppercase tracking-[0.25em] text-gold-accent-light">
                {categoryLabel}
              </span>
              <h1 className="mt-2 max-w-3xl font-heading text-3xl font-extrabold leading-tight tracking-tight text-white sm:text-4xl">
                {l.title}
              </h1>
              <p className="mt-4 max-w-2xl text-lg leading-relaxed text-mint-bg/80">
                {l.shortDescription}
              </p>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-12 lg:px-8">
          <div className="lg:col-span-8">
            ...
            <ul className="grid gap-3 sm:grid-cols-2">
              {l.features.map((f) => (
                <li
                  key={f}
                  className="flex items-start gap-3 rounded-xl border border-green-light bg-white px-4 py-3"
                >
            ...
            {faqs.length > 0 && (
              <div className="mt-12">
                ...
                <div className="mt-5 rounded-2xl border border-green-light bg-white px-6 py-2">
          ...
          <aside className="lg:col-span-4">
            <div className="lg:sticky lg:top-28">
              ...
              {l.keywords.length > 0 && (
                <div className="mt-6 rounded-2xl border border-green-light bg-white p-6">
                  ...
                  <ul className="mt-3 flex flex-wrap gap-2">
                    {l.keywords.map((k) => (
                      <li
                        key={k}
                        className="rounded-full bg-mint-bg px-3 py-1 text-xs text-green-dark"
                      >
                        {k}
                      </li>
                    ))}
