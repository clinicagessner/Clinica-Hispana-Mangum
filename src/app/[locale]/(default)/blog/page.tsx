  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-linear-to-b from-mint-warm to-mint-bg py-16 lg:py-20">
        <div
          aria-hidden
          className="pointer-events-none absolute -left-24 -top-16 h-80 w-80 rounded-full bg-green-soft/15 blur-3xl"
        />
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <Reveal>
            <p className="text-xs font-semibold uppercase tracking-[0.25em] text-gold-accent-dark">
              Clínica Hispana Mangum
            </p>
      ...
      <FaqSection items={HOME_FAQS} className="bg-mint-bg" />
    </>
  );
}
