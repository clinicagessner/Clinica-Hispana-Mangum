...
export function LandingFooter() {
  ...
  return (
    <footer className="bg-green-deep py-10 text-mint-bg/80">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <p className="mt-2 max-w-xl text-xs text-mint-bg/50">
            {t("disclaimer")}
          </p>
          <div className="mt-2 flex items-center gap-4 text-xs text-mint-bg/50">
            <span>
