...
export function ContactForm({
  ...
  if (status === "success") {
    return (
      <div className="flex flex-col items-center rounded-2xl border border-green-light bg-white p-10 text-center shadow-sm">
        <span className="flex h-16 w-16 items-center justify-center rounded-full bg-green-light text-green-primary">
  ...
  return (
    <form
      ...
      noValidate
      className="rounded-2xl border border-green-light bg-white p-6 shadow-sm sm:p-8"
    >
      {/* Honeypot oculto */}
      <input
        type="text"
      ...
      {status === "error" && (
        <div className="mt-5 rounded-lg border border-red-accent-light bg-red-accent-bg px-4 py-3 text-sm text-red-accent-dark">
