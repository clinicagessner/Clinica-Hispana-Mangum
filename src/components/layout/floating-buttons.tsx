  ...
  return (
    <div className="pointer-events-none fixed bottom-5 right-4 z-40 flex flex-col items-end gap-3 sm:bottom-6 sm:right-6">
      ...
      <button
        ...
        className={cn(
          "pointer-events-auto flex h-11 w-11 items-center justify-center rounded-full border border-green-light bg-white text-green-dark shadow-md transition-all duration-300 hover:bg-mint-bg",
          scrolled
