      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-12">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="mt-5 max-w-xs text-sm leading-relaxed text-mint-bg/80">
              {t("tagline")}
            </p>
            {(SOCIAL_LINKS.facebook || SOCIAL_LINKS.instagram) && (
              <div className="mt-5">
                <p className="text-xs font-semibold uppercase tracking-widest text-gold-accent-light">
                  {t("followUs")}
                </p>
          ...
          <nav className="lg:col-span-2" aria-label={t("navTitle")}>
            ...
            <ul className="mt-4 space-y-2.5 text-sm">
              <li>
                <Link href="/" className="text-mint-bg/80 hover:text-gold-accent-light">
                  {tNav("home")}
                </Link>
              </li>
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="mt-4 space-y-3 text-sm">
              <li className="flex items-start gap-2.5">
                ...
                <span className="text-mint-bg/80">
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a
                  ...
                  className="break-all text-mint-bg/80 hover:text-gold-accent-light"
                >
                  {CONTACT_INFO.email}
                </a>
              </li>
        ...
        {/* Barra legal */}
        <div className="mt-4 flex flex-col items-start justify-between gap-3 text-xs text-mint-bg/60 sm:flex-row sm:items-center">
          <p>
