...
export function BlogCard({
  ...
  return (
    <Link
      href={`/blog/${post.slug}`}
      className={cn(
        "group flex flex-col overflow-hidden rounded-2xl border border-green-light bg-white transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:shadow-green-primary/5",
        className,
      )}
    >
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <h3 className="mt-3 font-heading text-lg font-bold leading-snug text-slate-dark group-hover:text-green-dark">
          {post.title}
        </h3>
