    ...
    <div className="overflow-hidden" ref={emblaRef}>
      <div className="flex touch-pan-y py-2">
        {items.map((item, i) => (
          ...
          >
            <figure className="group flex h-full flex-col rounded-2xl border border-green-light bg-white p-6 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:border-green-primary/30 hover:shadow-xl hover:shadow-green-primary/5">
              ...
              <div className="relative mt-3 flex-1">
                <Quote className="absolute -left-1 -top-1 h-6 w-6 text-gold-accent/20" />
              ...
              {/* Verificado */}
              <figcaption className="mt-5 flex items-center gap-1.5 border-t border-green-light pt-4 text-xs font-medium text-green-dark">
                <BadgeCheck className="h-4 w-4 text-green-primary" />
                {verifiedLabel}
              </figcaption>
            </figure>
          </div>
