          ...
          <div className="relative overflow-hidden rounded-4xl bg-linear-to-br from-green-deep via-green-dark to-green-deep px-6 py-12 text-mint-bg shadow-2xl shadow-green-deep/20 sm:px-10 lg:px-14 lg:py-16">
            ...
            <div className="relative grid gap-10 lg:grid-cols-2 lg:items-center">
              <div>
                ...
                <p className="mt-5 max-w-lg text-lg leading-relaxed text-mint-bg/80">
                  {t("body")}
                </p>
                <Link
                ...
                <ul className="mt-6 space-y-4">
                  {points.map((point) => (
                    <li key={point} className="flex items-start gap-3">
                      <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-green-soft text-green-deep">
                        <Check className="h-3.5 w-3.5" />
                      </span>
                      <span className="text-base text-mint-bg/90">{point}</span>
                    </li>
                  ))}
                </ul>
              </div>
