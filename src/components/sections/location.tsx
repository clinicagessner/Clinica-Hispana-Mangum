      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-12">
          ...
          <Reveal className="lg:col-span-5">
            <div className="flex h-full flex-col gap-6 rounded-2xl border border-green-light bg-white p-7 shadow-sm">
              ...
              <InfoRow icon={<Mail className="h-5 w-5" />} label={t("emailLabel")}>
                <a
                  ...
                  className="break-all hover:text-green-dark"
                >
                  {CONTACT_INFO.email}
                </a>
              </InfoRow>
          ...
          <Reveal delay={120} className="lg:col-span-7">
            <div className="h-full overflow-hidden rounded-2xl border border-green-light bg-white shadow-sm">
              <iframe
...
function InfoRow({
  ...
  return (
    <div className="flex items-start gap-4">
      <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-mint-bg text-green-primary">
        {icon}
      </span>
      <div>
